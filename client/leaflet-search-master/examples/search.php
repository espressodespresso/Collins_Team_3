 ...
 * https://github.com/***REMOVED***efanocudini/leaflet-search
 *
 * https://opengeo.tech/maps/leaflet-search
 *
 * Copyright 2013, Stefano Cudini - https://opengeo.tech/***REMOVED***efano-cudini/
 * Licensed under the MIT license.
 
 What's:
	 php code for te***REMOVED***ing jsonp and ajax features
	 
	 receive get parameters:
	 	q		 :	search text
	 	callback :	callback name for jsonp reque***REMOVED***
...
//load big data ***REMOVED***ore, cities15000.json (about 14000 records)
...
//simulate connection latency for localho***REMOVED*** te***REMOVED***s
@header("Content-type: application/json; charset=utf-8");

if(isset($_GET['callback']) and !empty($_GET['callback']))	//support for JSONP reque***REMOVED***
	echo $_GET['callback']."($JSON)";
else
	echo $JSON;	//AJAX reque***REMOVED***
